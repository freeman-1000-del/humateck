...
const CMD7 = "아래로 이동해 줘. <P>⚠️ 반드시 7번 명령('아래로 이동해 줘.') 위 마지막 번역문 끝의 <span style="background:#2a4f7c;padding:1px 6px;border-radius:4px;font-size:12px;font-weight:900;">⧉</span>
