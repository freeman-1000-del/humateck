...
(function (global) {
  ...
  var PLANS = {
    deluxe: {
      ...
      descKo: "PC 1대 · 구글 클라이언트 인증가이드",
      descEn: "1 PC · Google Client Authentication Guide",
    ...
    premium: {
      ...
      descKo: "PC 5대 (5인용) · 구글 클라이언트 인증가이드",
      descEn: "5 PCs (5 seats) · Google Client Authentication Guide",
