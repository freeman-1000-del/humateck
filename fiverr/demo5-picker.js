/* Copied from deployer-en/index.html Custom 50-country picker — demo attach only (max 5, 30-day) */
(function () {
  var MAX = 5;
  ...
  function demo5ExpiredMsg() {
    return "This demo country picker has expired (30-day review period). Please contact support@humateck.com";
  }
  ...
  function updateModalCount() {
    ...
    if (note) note.textContent = n + " / 5 selected";
    var rowNote = $("custom50CountNote");
    if (rowNote) rowNote.textContent = n + " / 5 selected";
  }
  ...
  function patchDemoPlan() {
    ...
    if (!demo5IsValid()) {
      if (pickBtn) {
        ...
        pickBtn.textContent = "Demo expired (30-day period ended)";
      }
      return;
    }
    ...
    if (pickBtn) {
      ...
      pickBtn.textContent = "Pick countries manually (demo · up to 5, Korea excluded)";
    }
